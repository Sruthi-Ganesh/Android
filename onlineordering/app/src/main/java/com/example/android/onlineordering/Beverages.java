...
public class Beverages extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order.add(new orderingPage("Cococola",18.00));
        order.add(new orderingPage("Pepsi",45.00));
        order.add(new orderingPage("Fanta",95.00));
        order.add(new orderingPage("Sprite",62.50));
