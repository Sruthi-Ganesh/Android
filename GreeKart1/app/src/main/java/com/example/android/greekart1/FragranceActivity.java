...
public class FragranceActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(FragranceActivity.this,ProductDescription.class);
                Uri uri = ContentUris.withAppendedId(ItemEntry.CONTENT_FRAGRANCE_URI,id);
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                return FragranceActivity.super.onOptionsItemSelected(item);
            }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,ItemEntry.CONTENT_FRAGRANCE_URI,projection,null,null,null);
    }
