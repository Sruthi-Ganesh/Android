...
public class DryFruitsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(DryFruitsActivity.this,ProductDescription.class);
                Uri uri = ContentUris.withAppendedId(ItemEntry.CONTENT_DRY_FRUITS_URI,id);
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                return DryFruitsActivity.super.onOptionsItemSelected(item);
            }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,ItemEntry.CONTENT_DRY_FRUITS_URI,projection,null,null,null);
    }
