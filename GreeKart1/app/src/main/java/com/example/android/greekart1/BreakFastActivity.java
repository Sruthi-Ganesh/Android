...
public class BreakFastActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(BreakFastActivity.this,ProductDescription.class);
                Uri uri = ContentUris.withAppendedId(ItemEntry.CONTENT_BREAKFAST_URI,id);
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                return BreakFastActivity.super.onOptionsItemSelected(item);
            }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,ItemEntry.CONTENT_BREAKFAST_URI,projection,null,null,null);
    }
