    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(GroceryActivity.this,ProductDescription.class);
                final Uri uri = ContentUris.withAppendedId(ItemEntry.CONTENT_URI,id);
                Log.v("GroceryActivity",  uri + "");
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                return GroceryActivity.super.onOptionsItemSelected(item);
            }
