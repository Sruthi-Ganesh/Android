...
import com.example.android.greekart1.email.*;
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    Toast.makeText(SignupActivity.this, "Already Registered or Check the Internet Connectivity",
                                            Toast.LENGTH_SHORT).show();
                                } else {

                                    MailActivity mail = new MailActivity(getApplicationContext());
                                    mail.setTextSignUp();
                                    mail.sendMail();
