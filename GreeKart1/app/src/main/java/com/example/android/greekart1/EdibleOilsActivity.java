...
public class EdibleOilsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(EdibleOilsActivity.this,ProductDescription.class);
                Uri uri = ContentUris.withAppendedId(ItemEntry.CONTENT_EDIBLE_OILS_URI,id);
        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                return EdibleOilsActivity.super.onOptionsItemSelected(item);
            }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,ItemEntry.CONTENT_EDIBLE_OILS_URI,projection,null,null,null);
    }
