...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void addAPet() {
        ...
        if(TextUtils.isEmpty(name)|| TextUtils.isEmpty(weightString) || mGender==0) {
...
// Defines a variable to contain the number of updated rows
            ...
            noOfRowsUpdated = getContentResolver().update(currentUri,values,null,null);
    ...
    private void deletePet()
    {
        ...
        if(currentUri!=null) {
            ...
            noOfRowsAffected = getContentResolver().delete(currentUri, null, null);
        }
