...
public class mail extends javax.mail.Authenticator {
    ...
    public mail() {
        ...
        _user = "sruthibadal@gmail.com"; // username
        _pass = "password"; // 20121996Srutz
        _from = "sruthibadal@gmail.com"; // email sent from
        ...
        if(!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") &&
            ...
            Session session = Session.getInstance(props, new javax.mail.Authenticator() {
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("sruthibadal@gmail.com","password");
                }
            });
...
// send email
            ...
            try {
                t.connect("smtp.gmail.com","sruthibadal@gmail.com","password");
